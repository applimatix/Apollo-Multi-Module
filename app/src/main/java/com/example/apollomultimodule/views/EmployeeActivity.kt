...
import com.example.apollomultimodule.databinding.ActivityEmployeeBinding
...
class EmployeeActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        with(viewModel) {
            employeeController.observe(this@EmployeeActivity, Observer {
            ...
            intent.getStringExtra(EmployeeActivity.EXTRA_EMPLOYEE_ID)?.let {
                fetchEmployee(it)
            }
        }
    }
